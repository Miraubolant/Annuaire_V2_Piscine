...
$trail = [
    ...
    ['name' => 'Tous les isolants',  'url' => $canonical_url],
];
    ...
    <div class="ph-grid">
        ...
        <div>
            ...
            <p style="font-size:15px;color:rgba(255,255,255,.65);margin-bottom:28px;line-height:1.7;">
                Annuaire complet des isolants certifiés <?= htmlspecialchars($artVille) ?> — contacts, avis et devis gratuit.
            </p>
...
<main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;">
        <p style="font-size:14px;color:var(--text-muted);">
            <?= $total ?> isolant<?= $total > 1 ? 's' : '' ?> référencé<?= $total > 1 ? 's' : '' ?> — page <?= $page ?>/<?= $pages ?>
        </p>
